...
class Cooked_Admin_Menus {
	...
	public function add_menu() {
		...
		add_menu_page( __( 'Recipes', 'cooked' ), __( 'Recipes', 'cooked' ), 'edit_cp_recipes', 'cooked_recipes_menu', '', 'none', 58 );
		add_submenu_page('cooked_recipes_menu', __('Add New','cooked'), __('Add New','cooked'), 'edit_cp_recipes', 'post-new.php?post_type=cp_recipe', '' );
	...
	public function add_admin_bar_menu() {
		...
		$wp_admin_bar->add_menu( array( 'id' => 'cooked-ab', 'title' => '<span class="ab-icon"></span>'.__('Recipes','cooked'), 'href' => get_admin_url() . 'edit.php?post_type=cp_recipe' ) );
		$wp_admin_bar->add_menu( array( 'parent' => 'cooked-ab', 'title' => __('All Recipes','cooked'), 'id' => 'cooked-recipes-ab', 'href' => get_admin_url() . 'edit.php?post_type=cp_recipe' ) );
		$wp_admin_bar->add_menu( array( 'parent' => 'cooked-ab', 'title' => __('Add New','cooked'), 'id' => 'cooked-add-new-ab', 'href' => get_admin_url() . 'post-new.php?post_type=cp_recipe' ) );
		$wp_admin_bar->add_menu( array( 'parent' => 'cooked-ab', 'title' => __('Settings','cooked'), 'id' => 'cooked-settings-ab', 'href' => get_admin_url() . 'admin.php?page=cooked_settings' ) );
	}
