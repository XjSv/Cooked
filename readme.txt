...
Version 1.8.2 adds the Notes feature, a new way to add notes to your recipes. It also adds the option to import recipes from the WP Delicious plugin.
...
* **NEW:** Added the Notes feature, a new field to add notes to your recipes.
