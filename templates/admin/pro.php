	...
	<div class="wrap about-wrap">
		<div id="cooked-welcome-panel" class="cooked-welcome-panel">
			...
			<div class="cooked-welcome-panel-intro">
                ...
                <?php
					/* translators: referring to "Cooked Pro" */
					echo wpautop( sprintf( __( 'The %s upgrade adds loads of new features like ratings, favorites, user profiles and more. Check out the list below for all of the details.', 'cooked' ), 'Cooked Pro' ) );
				?>
            </div>
