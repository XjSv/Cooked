			...
			<div class="cooked-welcome-panel-content">
				<div class="cooked-welcome-panel-column-container">
					<div class="cooked-welcome-panel-column">
						...
						<ul>
							<li><i class="cooked-icon cooked-icon-link-lt cooked-icon-fw"></i>&nbsp;&nbsp;<a href="https://github.com/XjSv/Cooked/wiki" target="_blank"><?php esc_html_e( 'Documentation','cooked' ); ?></a></li>
