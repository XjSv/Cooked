        ...
        <div id="cooked-welcome-panel" class="cooked-welcome-panel">
            ...
            <div class="cooked-welcome-panel-intro">
                ...
                <?php
                    ...
                    printf( esc_html__( 'Thanks for using %s!', 'cooked' ), 'Cooked' );
                ?>
                </h1>
                <?php
                    echo wp_kses_post(
                    ...
                    <div class="cooked-welcome-panel-column">
                        ...
                        <ul>
                            ...
                            if ( ! class_exists( 'Cooked_Pro_Plugin' ) ) :
                                ?>
                                <li class="cooked-pro"><i class="cooked-icon cooked-icon-star-lg cooked-icon-fw"></i>&nbsp;&nbsp;<a href="<?php echo esc_url( admin_url( 'admin.php?page=cooked_pro' ) ); ?>"><?php esc_html_e( 'Upgrade to Pro', 'cooked' ); ?></a></li><?php endif; ?>
                        </ul>
                    </div>
